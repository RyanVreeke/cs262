...
router.get("/showgameplayers", showGame);
router.get("/showgameplayers/:id", showGamePlayers);
...
function showGame(req, res) {
    res.send('To show the players in a certain game please put showgameplayers/id.');
}

function showGamePlayers(req, res, next) {
    db.many(`SELECT name
    FROM Player, PlayerGame
   WHERE PlayerGame.gameID = ${req.params.id}
